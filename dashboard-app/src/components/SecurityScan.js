...
import './SecurityScan.css'; // Import the CSS for styling

const ImageRisk = () => {
  return (
    <div className="card">
      <div className="image-risk">
        <h3 className="image-risk-heading">Image Security Issues</h3>
        <p className="total-vulnerabilities">
          <span className='total'>2</span> Total Images
        </p>
  ...
  <div className="horizontal-line">
    ...
    <div className="marker critical">
      <div className="color-box"></div>Critical (2)
    </div>
    <div className="marker high">
      <div className="color-box"></div>High (2)
    </div>
    <div className="marker medium">
      <div className="color-box"></div>Medium (2)
    </div>
    <div className="marker mild">
      <div className="color-box"></div>Mild (2)
    </div>
    <div className="marker low">
      <div className="color-box"></div>Low (2)
    </div>
  </div>
</div>
      </div>
